...
using System.Linq; //for the Where() function for lists
using UnityEngine;
using UnityEngine.UI;
using Yarn.Unity;
using TMPro;

public class SeasideLineView : DialogueViewBase
{
    /// <summary>
    ...
    private IEnumerator DismissLineInternal(System.Action onDismissalComplete)
    {
    ...
    private IEnumerator RunLineInternal(LocalizedLine dialogueLine, System.Action onDialogueLineFinished)
    {
